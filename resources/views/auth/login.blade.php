...
<div class="login-box">
    ...
    <div class="card">
        ...
        <div class="login-logo">
            <img src="{{ asset('img').'/silatih.jpg' }}"width="100" alt="" title="">
        </div>
            
        <p class="login-box-msg">SiLatih v.1</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Berhasil!</strong> Registrasi berhasil. Silahkan tunggu konfirmasi admin.
                    </div> 
                </div>
            </div>
        @endif
