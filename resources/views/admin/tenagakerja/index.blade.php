                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @if (count($result['tenagakerjadata']) > 0)
                                  @php $i = $result['i']; $i < count($result['tenagakerjadata']);  @endphp
                                    @foreach ($result['tenagakerjadata'] as $tenagakerjadata )
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-xs " data-toggle="modal" data-target="#modalEdit{{$tenagakerjadata->id}}" ><i class="fa fa-user-edit"></i></button>
                                                <button class="btn btn-danger btn-xs " data-toggle="modal" data-target="#modalHapus{{$tenagakerjadata->id}}" ><i class="fas fa-trash"></i></button>
